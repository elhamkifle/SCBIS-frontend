...
export default function RenewalRequestApprovedPage() {
                ...
                <main className="flex-1 mt-6">
                    ...
                    <div className="max-w-4xl mx-auto p-6 bg-white shadow-lg rounded-lg border mb-8" style={{ boxShadow: '0px 10px 20px rgba(0, 123, 255, 0.4), 0px 4px 8px rgba(0, 0, 0, 0.1)' }}>
                        ...
                        <div className="flex justify-between px-24 gap-4 mt-8">
                            <button
                                className="bg-green-600 text-white px-8 py-2 rounded hover:bg-green-700 font-semibold w-1/2"
                                onClick={() => router.push('/dashboard')}
                            >
                                Accept
                            </button>
                            <button
                                className="bg-red-600 text-white px-8 py-2 rounded hover:bg-red-700 font-semibold w-1/2"
                                onClick={() => router.push('/dashboard')}
                            >
                                Reject
                            </button>
