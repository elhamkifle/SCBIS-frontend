  ...
  return (
    <main className="bg-white min-h-screen text-gray-800">
      <div className="max-w-7xl mx-auto px-4 pt-8 pb-12">
        ...
        </h1>        <div className="flex flex-row flex-wrap justify-between items-center gap-8 mb-14">
        ...
        <section>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-x-8 gap-y-10 justify-items-center">
            {claims.map((claim) => {
              const formattedDate = formatDate(claim.dateSubmitted || claim.createdAt);              return (
