    ...
    <div className="max-w-5xl mx-auto p-6 bg-white">
      ...
      <div className="border-b pb-4 mb-4">
        ...
        {isEditing.liability ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4 px-4">
            ...
            <div>
              <strong>Other Vehicle Insured:</strong> <YesNoDisplay value={otherInsuredStatus === 'Yes , they are'} />
              {otherInsuredStatus === 'Yes , they are' && (
                <p><strong>Insurance Company:</strong> {OtherInsuranceCompanyName}</p>
              )}
            </div>
            <div>
              <strong>Police Involved:</strong> <YesNoDisplay value={policeInvolved} />
              {policeInvolved === 'Yes' && (
                <>
      ...
      <div className="border-b pb-4 mb-4">
        ...
        {isEditing.damage ? (
          ...
          <div className="grid grid-cols-1 gap-4 mt-4 px-4">
            ...
            <div>
              <strong>Injuries:</strong> <YesNoDisplay value={injuriesAny} />
              {injuriesAny && (
                <>
      ...
      <div className="mb-8">
        ...
        {isEditing.witness ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4 px-4">
            <div>
              <strong>Alone in Vehicle:</strong> <YesNoDisplay value={aloneInVehicle === 'Yes I was'} />
            </div>
            ...
            <div className="col-span-2">
              <strong>Independent Witnesses:</strong> <YesNoDisplay value={independentWitnessPresent === 'Yes'} />
